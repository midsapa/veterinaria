 <%@ Page Title="" Language="C#" MasterPageFile="~/MasterADCV.master" AutoEventWireup="true" CodeFile="Comida.aspx.cs" Inherits="Comida" %>
   ...
   <div class="block-heading">        
    <div class="content">
       <div class="row">        
            ...
            <asp:DataList ID="dtcomid" runat="server" DataKeyField="idprod" Height="464px" RepeatColumns="3" RepeatDirection="Horizontal" Width="834px" OnItemCommand="muestra">
            <ItemTemplate>
