<%@ Page Title="" Language="C#" MasterPageFile="~/MasterADCV.master" AutoEventWireup="true" CodeFile="detalleotros.aspx.cs" Inherits="detalleotros" %>
                ...
                <div class="block-content">
                    <div class="product-info">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="info">
                                    <asp:DataList ID="datdetallitos" runat="server" RepeatDirection="Horizontal" DataKeyField="idprod">
                                        <ItemTemplate>
                                            ...
                                            <br />
                                            <asp:Button ID="btncarrito" class="btn btn-primary"  runat="server" Text="Comprar" />
                                        </ItemTemplate>
                                    </asp:DataList>
                                </div>
                            </div>
